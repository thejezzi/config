...
ZSH_THEME="robbyrussell" #"bullet-train"
...
# cdd - cd combined with fd-find and fzf that takes a path to search for and
#       a directory to search in
alias cdd='function cdd() { local dir; dir=$(fd -t d . | fzf +m) && cd "$dir"; }; cdd'
bindkey -s '^q' 'cdd\n'
bindkey -s '^w' 'cd && cdd\n'
